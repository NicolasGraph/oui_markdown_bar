...
$plugin['version'] = '0.7beta';
$plugin['author'] = 'Nicolas Morand, Jukka Svahn';
$plugin['author_uri'] = '';
$plugin['description'] = 'Simple Markdown inserting bar for the Write tab\'s Body-textarea';
...
*/
	...
	function rah_textile_bar_buttons() {
		...
		$b[] = array('ul','ul','* ','\\n');
		$b[] = array('ol','ol','1. ','\\n');
		$b[] = array('sup','sup','<sup>','</sup>');
		$b[] = array('sub','sub','<sub>','</sub>');
		$b[] = array('bq','bq','> ','\\n\\n');
		$b[] = array('bc','bc','```\\n','\\n```');
